...
const string strMessageMagic = "Mysticoin Signed Message:\n";
...
{
    int64_t nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 7);
    ...
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 7);
    }
}
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Mysticoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "05 Aug 2015 Satoshi Nakamoto moves his 6.5 yr old bitcoins";
        CTransaction txNew;
        txNew.nTime = 1438785036;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1438785036;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2331568;
		if(fTestNet)
        {
            block.nNonce   = 263150;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xed693b207b3aa8a128359e20298c2832c814c5435a40399ae9689a666747f437"));
