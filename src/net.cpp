...
bool GetMyExternalIP(CNetAddr& ipRet)
{
    ...
    for (int nHost = 1; nHost <= 2; nHost++)
    {
        ...
        if (nHost == 1)
        {
            addrConnect = CService("45.32.68.232",80); // checkip.dyndns.org
        ...
        {
            addrConnect = CService("altbazzar.io", 80); // www.showmyip.com
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Mysticoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    	{"95.85.27.103", "95.85.27.103"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("Mysticoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("Mysticoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("Mysticoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("Mysticoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Mysticoin is probably already running."), addrBind.ToString().c_str());
        else
